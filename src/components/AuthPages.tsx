...
<div
  id="demo-profiles-container"
  className="bg-white rounded-3xl p-6 sm:p-8 border border-stone-200 shadow-xl shadow-stone-200/50"
>
  <h3 className="text-xs font-black text-stone-400 uppercase tracking-widest mb-4 flex items-center">
    ...
    <span>Click to Instant Login as Demo Role:</span>
  </h3>
...
```
  ...
  <div className="mt-4 text-[11px] text-stone-450 text-center leading-normal">
    No registration payload needed to test! Just click any button to skip auth forms.
    Password default is{" "}
